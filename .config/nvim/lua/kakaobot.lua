...
function M.send_message()
  vim.ui.input({ prompt = "보낼 메시지를 입력하세요: " }, function(input)
...
-- 명령어 등록
vim.api.nvim_create_user_command("KakaoSend", function()
  M.send_message()
end, {})
vim.api.nvim_create_user_command("KakaoReply", function()
  M.get_response()
end, {})

-- 키맵 등록 (Space + k + s, Space + k + r)
